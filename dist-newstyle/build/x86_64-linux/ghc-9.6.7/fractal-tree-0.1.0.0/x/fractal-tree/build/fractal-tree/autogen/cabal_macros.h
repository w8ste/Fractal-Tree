...
/* package fractal-tree-0.1.0.0 */
#ifndef VERSION_fractal_tree
#define VERSION_fractal_tree "0.1.0.0"
#endif /* VERSION_fractal_tree */
#ifndef MIN_VERSION_fractal_tree
#define MIN_VERSION_fractal_tree(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fractal_tree */
...
#define CURRENT_COMPONENT_ID "fractal-tree-0.1.0.0-inplace-fractal-tree"
